...
public interface TemplateSupport {
	...
	<T> T decodeEntity(String id, String source, long cas, Class<T> entityClass, String scope, String collectin, TransactionResultHolder txResultHolder, ClientSession session);
