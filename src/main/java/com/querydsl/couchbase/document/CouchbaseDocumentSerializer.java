...
import org.springframework.data.couchbase.repository.support.DocRef;
...
public abstract class CouchbaseDocumentSerializer implements Visitor<Object, Void> {
	...
	public Object visit(Operation<?> expr, Void context) {
		...
		if (op == Ops.EQ) {
			...
			return QueryCriteria.where(asDBKey(expr,1)).isNotMissing();
	...
	protected DocRef asReferenceKey(Class<?> entity, Object id) {
		// TODO override in subclass
		throw new UnsupportedOperationException();
	}

	protected abstract DocRef asReference(Object constant);
